				...
				<div id="featured-posts">
					<div id="coda-nav">
						<div class="coda-slider<?php	 	 if ($disable['2'] == '1') { ?> no-categories<?php	 	 } ?>" id="slider">
							<?php	 	 get_template_part( 'loop', 'carousel_it' ); ?>
						</div> <!-- coda-slider -->
					</div> 
					<!-- coda-nav -->
				</div> <!-- featured-posts -->
...
--> 
			...
			<div id="post-container">
				...
				<div id="posts">
					<p class="gallery-description">Benvenuti su Dicke Katze and Friends</p>
					...
					<?php	 	 if (of_get_option("enable_home_category")) : ?>
						<?php	 	
							...
							query_posts("cat=148&showposts=$home_num");
						?>
