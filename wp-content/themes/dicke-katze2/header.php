...
<META NAME="KEYWORDS" CONTENT="funny cats, funny cat videos, dickee cats, dicke cats, dicke katz, stuffies, cat toys, cat photos, cat, fat cat, cute cats, Dicke Katze, Olivia Vieweg, kitties, kittens, cuddly, hello kitty, cheezburgers,">
<META NAME="KEYWORDS" DESCRIPTION="Dickie Katze and Friends. Fat cats and their friends tell you why cats are so cool.">
...
<meta name="p:domain_verify" content="7f69da832e19042047d36c112e1984be" />
	...
	<link href='https://fonts.googleapis.com/css?family=Lobster|Shadows+Into+Light|Indie+Flower|Pacifico|Bangers|Lobster+Two' rel='stylesheet' type='text/css'>
	...
	<div id="header" style="float:right;height:200px;">
		<div id="header-inside">
			...
			<?php if (of_get_option('logo_text')) : ?>
				<h1><a href="<?php echo home_url(); ?>/" title="Home" ><?php echo of_get_option('logo_text'); ?></a></h1>
			<?php else : ?>
				<a href="<?php echo home_url(); ?>/" title="Home" ><img src="<?php echo ($logo = of_get_option('logo_image')) ? $logo : get_template_directory_uri() . "/images/logo.png"; ?>" alt="<?php bloginfo('name'); ?>" /></a>
			<?php endif; ?>
			</div> <!-- header-left -->
			
			<div id="header-right">
<!--<div id="header-login"><?php wp_register(); ?> <?php wp_loginout(); ?></div>-->
